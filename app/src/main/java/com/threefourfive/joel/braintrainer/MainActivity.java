    ...
    public void setQAField(){
        ...
        switch (option){
            case 1: a0.setText(solutionstring);
                    a1.setText(Integer.toString(rand(1,150,random)));
                    a2.setText(Integer.toString(rand(1,150,random)));
                    a3.setText(Integer.toString(rand(1,150,random)));
                    break;
            case 2: a0.setText(Integer.toString(rand(1,150,random)));
                    a1.setText(solutionstring);
                    a2.setText(Integer.toString(rand(1,150,random)));
                    a3.setText(Integer.toString(rand(1,150,random)));
                    break;
            case 3: a0.setText(Integer.toString(rand(1,150,random)));
                    a2.setText(solutionstring);
                    a1.setText(Integer.toString(rand(1,150,random)));
                    a3.setText(Integer.toString(rand(1,150,random)));
                    break;
            case 4: a0.setText(Integer.toString(rand(1,150,random)));
